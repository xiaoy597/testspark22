...
spark-submit \
	...
	--jars $DEPS \
	test-spark-2-1.0-SNAPSHOT.jar cluster aisvr2:6667,aisvr3:6667,aisvr4:6667 sztran $CONSUMER_GRP 80000 /user/hive/warehouse/nsdsdata2.db/csdc_s_sec_tran_tst/trad_date=2016-09-01
