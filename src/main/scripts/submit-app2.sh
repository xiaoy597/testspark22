...
./lib/kafka-clients-0.10.0.0.jar,\
...
spark-submit \
	...
	--jars $DEPS \
	test-spark-2-1.0-SNAPSHOT.jar cluster host2:6667,host3:6667,host4:6667 szquot3s 200 180 1 0.20 0.21 0.22 0.05 0.2 0.4
